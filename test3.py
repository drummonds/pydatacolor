...
show_result(f"2 [16 08 00 0B 00 02] (00 03 68)",  dc.send([2, 8, 0x16, 8, 0, 0x0B, 0, 2]), "firmware version")
show_result(f"3 [16 08 00 18 00 01] (00 06)", dc.send([3, 8, 0x16, 8, 0, 0x18, 0, 1]), "?")
show_result(f"4 [16 08 00 26 00 01] (00 10)", dc.send([4, 8, 0x16, 8, 0, 0x26, 0, 1]), "Soft reset?") 
show_result(f"5 [16 08 00 37 00 01] (00 04)", dc.send([5, 8, 0x16, 8, 0, 0x37, 0, 1]), "?")
show_result(f"6 [16 08 00 37 00 01] (00 00 03 C5 20)", dc.send([6, 8, 0x16, 8, 0, 0x0D, 0, 4]), "?")
show_result(f"7 [02]                (0,0,0,0,1)", dc.send([7,3,2], timeout=100), "?")
show_result(f"8 [16 08 07 FC 00 04] (00 00 03 C5 20)", dc.send([8, 8, 0x16, 8, 7, 0xFC, 0, 4]), "?")
show_result(f"9 [22]                (00 01 05 0A 0A 01)", dc.send([9,3,0x22], timeout=100), "?")
show_result(f"A [02]                ()", dc.send([0x0A,3,0], timeout=100, timeout_ok=True), "?")
